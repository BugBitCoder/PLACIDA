...
|---|---|---|---|
| Mood chart shows | Log 3 moods on different days, go to Dashboard | Bar chart appears with data | ✅ |
| Streak counter | Log mood today, check dashboard subtitle | "🔥 1-day streak" shown | ✅ |
| Time greeting | Open dashboard at different times | Correct morning/afternoon/evening/night |  ✅ |
| Clear data | Click "Clear All", confirm, check dashboard | All data wiped, stats reset | ✅ |
